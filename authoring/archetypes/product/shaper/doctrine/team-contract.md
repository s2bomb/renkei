...
- `shaper` -- owns framing synthesis, bounded recommendation, and shaped artifact quality.
...
- Delegate to `problem-analyst` when evidence is weak, framing is ambiguous, or scope is multi-item.
- Consult `tech-lead` when appetite or boundaries imply material feasibility uncertainty.
- Delegate to `tech-lead` after `active` transition scaffold and ledger requirements are satisfied.
